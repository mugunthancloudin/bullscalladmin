...
const contractAddress = "0xE405B2227a2F6c7B91068A68A128B45eF52737E7";
...
const changeCurrentAdminAccess=async(address)=>{
  try {
    ...
    let changeCurrentAdminEntityStatus = await changeCurrentAdminEntity.wait();
    let changeCurrentAdminEntityTransactionHash = changeCurrentAdminEntity.hash;
...
const getAllAdminEntity=async()=>{
  try {
    ...
    // let receiptDownStatus = await getAdminAccess.wait();
    console.log(getAdminAccess);
